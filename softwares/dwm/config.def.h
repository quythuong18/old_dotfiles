...
static const char *mutevol[] = { "/usr/bin/pulsemixer", "--mute", NULL};
...
static const char *termcmd_st_float_bc[]  = { "st", "-T", "StFloat", "-g", "75x22+500+270", "bc", "-q", NULL };
...
static const char *zoom_screen[]  = { "/home/quythuong/softwares/zoom.sh", NULL };
